...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "workflow-automation";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "workflow-automation.war")
            ...
            .addPackages(false, "ch.umb.hackathon.devops") // not recursive to skip package 'nonarquillian'
